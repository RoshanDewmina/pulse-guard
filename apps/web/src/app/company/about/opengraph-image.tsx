...
export const alt = 'About Saturn - Cron Monitoring with Anomaly Detection';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Making scheduled job reliability observable and proactive through statistical anomaly detection
          </div>
