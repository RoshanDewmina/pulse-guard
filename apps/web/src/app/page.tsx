...
export default function LandingPage() {
  ...
  const getDashboardContent = () => {
    switch (activeCard) {
      case 0:
        return <div className="text-[#828387] text-sm">Monitor Dashboard - Health Scores & Status</div>
      case 1:
        return <div className="text-[#828387] text-sm">Analytics - MTBF, MTTR, Anomaly Detection</div>
      case 2:
        return <div className="text-[#828387] text-sm">Runtime Trends - Duration Analysis & Insights</div>
      default:
        return <div className="text-[#828387] text-sm">Monitor Dashboard - Health Scores & Status</div>
    }
  }
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div className="flex justify-center items-center">
                  ...
                  <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                    <Link href="/#features" className="flex justify-start items-center hover:opacity-60 transition-opacity">
                      <div className="flex flex-col justify-center text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium leading-[14px] font-sans">
                        Products
                      </div>
                    </Link>
                    <Link href="/#pricing" className="flex justify-start items-center hover:opacity-60 transition-opacity">
                      <div className="flex flex-col justify-center text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium leading-[14px] font-sans">
                        Pricing
                      </div>
                    </Link>
              ...
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    ...
                    Built for DevOps teams monitoring business-critical jobs.
                  </div>
                </div>
              </div>
                      ...
                      <div className="relative w-full h-full overflow-hidden">
                        ...
                        >
                          <Image
                            ...
                            alt="Monitor Dashboard - Health Scores and Status Overview"
                        ...
                        >
                          <Image
                            ...
                            alt="Analytics Dashboard - MTBF, MTTR, and Anomaly Trends"
                            className="w-full h-full object-cover"
                            fill
                          />
                        </div>
                        ...
                        >
                          <Image
                            ...
                            alt="Runtime Trends - Duration Analysis and Performance Insights"
                      ...
                      return (
                        ...
                        >
                          <div className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 relative shadow-[0px_-4px_8px_rgba(255,255,255,0.64)_inset] overflow-hidden rounded-full">
                            <Image src="/horizon-icon.svg" alt="Horizon" className="w-full h-full object-contain" width={40} height={40} />
                          </div>
